                ...
                <div class="phase progress">
                    <div class="phase-card">
                        ...
                        <ul>
                            ...
                            <li>Customer self-registration + OTP-based login — built. Mobile-number-only signup/login form; static <strong>123456</strong> when <code>APP_ENV=local</code>, a real random code (logged, not sent) otherwise since no SMS gateway is wired yet</li>
                            <li>Mandatory post-OTP profile completion — built. Name, address, alternate number and pincode are checked right after verify; missing any of them routes to a "few more details" form before the dashboard, already-complete skips straight there</li>
