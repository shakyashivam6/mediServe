{{--
    Captain panel layout — cloned from store-layout.blade.php (same reasoning
    for staying its own file: lets the areas diverge freely later). Same
    HighDmin theme chrome, same common.sidenav include; the sidenav itself
    switches to the Captain menu based on auth()->user()->role (see
        ...
        <header class="app-topbar">
            <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <!-- Brand Logo -->
                    <a href="{{ route('captain.dashboard') }}" class="logo">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    @include('common.notifications-dropdown', ['rolePrefix' => 'captain'])
                    ...
                    <div class="topbar-item nav-user">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <!-- item-->
                                <a href="{{ route('captain.dashboard') }}" class="dropdown-item">
